        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <section id="contact" class="margin-bottom-70">
                    ...
                    <h4><i class="sl sl-icon-user"></i> Login Details</h4>
                    <form method="POST" action="login">
                        ...
                        <input type="submit" class="submit button" id="submit" value="Login" />
                    </form>
                    <div class="col-md-6">
                        <a href="{{url('register')}}" style="color:#3fb4e4">Sign up for New User</a>
                    </div>
                    <div class="col-md-6" align="right">
                        <a href="{{url('#')}}" style="color:#3fb4e4">Forgot Password</a>
                    </div>
                </section>
            </div>
            <div class="col-md-3">
