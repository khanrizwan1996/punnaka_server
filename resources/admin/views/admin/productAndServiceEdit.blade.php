    ...
    <div id="page_content_inner">
        <div id="top_bar">
            <ul id="breadcrumbs">
                ...
                <li><span>Product & Service Edit </span></li>
            </ul>
        </div>
                ...
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-1-2">
                        <label for="" style="font-weight: bolder;font-size: 15px;">Selected Main Category : <span
                                style="color:#1976d2"> {{ $getProductServiceData->ps_main_cat }}</span></label>
                    </div>
                    <div class="uk-width-medium-1-2">
                        <label for="" style="font-weight: bolder;font-size: 15px;">Selected Sub Category : <span
                                style="color:#1976d2"> {{ $getProductServiceData->ps_sub_cat }}</span></label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="md-card">
            <div class="md-card-content large-padding">
                <form id="form_validation" method="POST"
                    action="{{ url('admin/productAndServiceUpdate/'.$getProductServiceData->ps_id) }}" enctype="multipart/form-data"
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="parsley-row">
                                <select class="md-input" name="ps_user_id" id="ps_user_id">
                                    ...
                                    @foreach ($UserData as $UserRow)
                                        <option value="{{ $UserRow['id'] }}" @if ($UserRow->id == $getProductServiceData->ps_user_id) selected style="color:red" @endif >{{ $UserRow['name'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="uk-width-medium-1-4">
                            <label for="ps_main_cat">Main Category <span class="req"
                        ...
                        <div class="uk-width-medium-1-4">
                            <label for="ps_sub_cat">Sub Category <span class="req"
                                    style="color: red">*</span></label>
                            <div class="parsley-row">
                            ...
                            <div class="parsley-row">
                                <input type="text" name="ps_title" value="{{ $getProductServiceData->ps_title }}"
                            ...
                            <div class="parsley-row">
                                <select class="md-input" name="ps_listing_type" id="ps_listing_type" required>
                                    ...
                                    <option value="Product"
                                        @if ($getProductServiceData->ps_listing_type == 'Product') selected style="color:red" @endif>Product</option>
                                    <option value="Service"
                                        @if ($getProductServiceData->ps_listing_type == 'Service') selected style="color:red" @endif>Service</option>
                                    <option value="Both"
                                        @if ($getProductServiceData->ps_listing_type == 'Both') selected style="color:red" @endif>Both</option>
                                </select>
                            </div>
                        </div>
                        <div class="uk-width-medium-1-4">
                            ...
                            <div class="parsley-row">
                                <select class="md-input" name="ps_status">
                                    <option value="">Choose..</option>
                                    <option value="{{ STATUS_ACTIVE }}"
                                        @if ($getProductServiceData->ps_status == STATUS_ACTIVE) selected style="color:green" @endif>Active
                                    </option>
                                    <option value="{{ STATUS_INACTIVE }}"
                                        @if ($getProductServiceData->ps_status == STATUS_INACTIVE) selected style="color:red" @endif>In Active
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="uk-width-medium-1-4">
                            <div class="parsley-row">
                                ...
                                <select class="md-input" name="ps_pricing_type" id="ps_pricing_type" required>
                                    <option value="">Select</option>
                                    <option value="Fixed"
                                        @if ($getProductServiceData['ps_pricing_type'] == 'Fixed') selected style="color:red" @endif>Fixed</option>
                                    <option value="Hourly"
                                        @if ($getProductServiceData['ps_pricing_type'] == 'Hourly') selected style="color:red" @endif>Hourly</option>
                                    <option value="Range"
                                        @if ($getProductServiceData['ps_pricing_type'] == 'Range') selected style="color:red" @endif>Range</option>
                                    <option value="Package Price"
                                        @if ($getProductServiceData['ps_pricing_type'] == 'Package Price') selected style="color:red" @endif>Package Price
                                    </option>
                                    <option value="Contact for price"
                                        @if ($getProductServiceData['ps_pricing_type'] == 'Contact for price') selected style="color:red" @endif>Contact for
                                        price</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="uk-width-medium-1-6">
                            <div class="parsley-row">
                                ...
                                <input class="md-input" type="text" name="ps_price_range" id="ps_price_range"
                                    value="{{ $getProductServiceData['ps_price_range'] }}"
                        ...
                        <div class="uk-width-medium-1-6">
                            <div class="parsley-row">
                                ...
                                <input class="md-input" type="text" name="ps_discount" id="ps_discount"
                                    value="{{ $getProductServiceData['ps_discount'] }}"
                        ...
                        <div class="uk-width-medium-1-4">
                            <div class="parsley-row">
                                ...
                                <input class="md-input" type="text" name="ps_tax" id="ps_tax"
                                    value="{{ $getProductServiceData['ps_tax'] }}"
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-4">
                            ...
                            <input class="md-input" type="text" name="ps_country" id="ps_country"
                                value="{{ $getProductServiceData['ps_country'] }}" placeholder="Enter Country" required>
                        </div>
                        <div class="uk-width-medium-1-4">
                            <label class="form-label">State <span class="text-danger">*</span></label>
                            <input class="md-input" type="text" name="ps_state" id="ps_state"
                                value="{{ $getProductServiceData['ps_state'] }}" placeholder="Enter State" required>
                        </div>

                        <div class="uk-width-medium-1-4">
                            <label class="form-label">City <span class="text-danger">*</span></label>
                            <input class="md-input" type="text" name="ps_city" id="ps_city"
                                value="{{ $getProductServiceData['ps_city'] }}" placeholder="Enter City" required>
                        </div>
                        <div class="uk-width-medium-1-4">
                            ...
                            <select class="md-input" name="ps_service_area" id="ps_service_area" required>
                                <option value="">Select</option>
                                <option value="Local"
                                    @if ($getProductServiceData['ps_service_area'] == 'Local') selected style="color:red" @endif>Local</option>
                                <option value="National"
                                    @if ($getProductServiceData['ps_service_area'] == 'National') selected style="color:red" @endif>National</option>
                                <option value="Global"
                                    @if ($getProductServiceData['ps_service_area'] == 'Global') selected style="color:red" @endif>Global</option>
                                <option value="Online"
                                    @if ($getProductServiceData['ps_service_area'] == 'Online') selected style="color:red" @endif>Online</option>
                                <option value="Offline"
                                    @if ($getProductServiceData['ps_service_area'] == 'Offline') selected style="color:red" @endif>Offline</option>
                            </select>
                        </div>
                        ...
                        <div class="uk-width-medium-1-4">
                            ...
                            <input class="md-input" type="datetime-local" name="ps_availability_date_time"
                                value="{{ $getProductServiceData['ps_availability_date_time'] }}"
                                id="ps_availability_date_time" placeholder="Enter Availability (For Services) Date Time"
                                required>
                        </div>
                        ...
                        <div class="uk-width-medium-1-4">
                            ...
                            <select class="md-input" required id="ps_additional_options" name="ps_additional_options"
                                ...
                                <option value="Products"
                                    @if ($getProductServiceData['ps_additional_options'] == 'Products') selected style="color:red" @endif>Products</option>
                                <option value="Services"
                                    @if ($getProductServiceData['ps_additional_options'] == 'Services') selected style="color:red" @endif>Services</option>
                            </select>
                        </div>

                        <div class="uk-width-medium-1-4" @if ($getProductServiceData['ps_additional_options'] == 'Products') visible @else hidden @endif"
                            id="div_ps_size">
                           
                            <label class="form-label">Size <span class="text-danger">*</span></label>
                              <input class="md-input" type="text" name="ps_size" id="ps_size"
                                value="{{ $getProductServiceData['ps_size'] }}" placeholder="Enter Size">
                        </div>
                        ...
                        <div class="uk-width-medium-1-4" @if ($getProductServiceData['ps_additional_options'] == 'Products') visible @else hidden @endif"
                            id="div_ps_color">
                             ...
                             <input class="md-input" type="text" name="ps_color" id="ps_color"
                                value="{{ $getProductServiceData['ps_color'] }}" placeholder="Enter Color">

                            
                        </div>

                        <div class="uk-width-medium-1-1" @if ($getProductServiceData['ps_additional_options'] == 'Products') visible @else hidden @endif"
                            id="div_ps_return_policy">
                            <br>
                            ...
                            <textarea class="md-input" type="text" name="ps_return_policy" id="ps_return_policy"
                                placeholder="Enter Return Policy" rows="5" cols="5">{{ $getProductServiceData['ps_return_policy'] }}</textarea>
                        </div>
                        </div>

                        <div class="uk-width-medium-1-1" @if ($getProductServiceData['ps_additional_options'] == 'Services') visible @else hidden @endif"
                            id="div_ps_cancellation_policy">
                            <br>
                            ...
                            <textarea class="md-input" type="text" name="ps_cancellation_policy" id="ps_cancellation_policy"
                                placeholder="Enter Cancellation Policy" rows="5" cols="5"> {{ $getProductServiceData['ps_cancellation_policy'] }}</textarea>
                        </div>
                        ...
                        <div class="uk-width-medium-1-1" @if ($getProductServiceData['ps_additional_options'] == 'Services') visible @else hidden @endif"
                            ...
                            <textarea class="md-input" type="text" name="ps_add_ons" id="ps_add_ons" placeholder="Enter Add-ons"
                                rows="5" cols="5"> {{ $getProductServiceData['ps_add_ons'] }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-4">
                            ...
                            <input class="md-input" type="text" name="ps_stock" id="ps_stock"
                                value="{{ $getProductServiceData['ps_stock'] }}" placeholder="Enter Stock" required>
                        </div>
                        <div class="uk-width-medium-1-4">
                            <label class="form-label">SKU <span class="text-danger">*</span></label>
                            <input class="md-input" type="text" name="ps_sku" id="ps_sku"
                                value="{{ $getProductServiceData['ps_sku'] }}" placeholder="Enter SKU" required>
                        </div>
                        <div class="uk-width-medium-1-4">
                            ...
                            <input class="md-input" type="text" name="ps_shipping_option" id="ps_shipping_option"
                                value="{{ $getProductServiceData['ps_shipping_option'] }}"
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-3">
                            <label for="ps_image">Image <span class="req" style="color: red">*</span>
                                ...
                                <a target="_blank"
                                    href="{{ url('custom-images/product-service/' . $getProductServiceData->ps_image) }}">(View
                                    Image)</a></label>
                            <div class="parsley-row">
                        ...
                        <div class="uk-width-medium-1-3">
                            <label class="form-label" for="formFile1">Brochure <span
                                ...
                                <a target="_blank"
                                    href="{{ url('custom-images/product-service/' . $getProductServiceData['ps_brochure']) }}">(View
                                    Brochure)</a></label>
                            <div class="parsley-row">
                        ...
                        <div class="uk-width-medium-1-3">
                            ...
                            <input class="md-input" type="text" name="ps_video_url" id="ps_video_url"
                                value="{{ $getProductServiceData['ps_video_url'] }}"
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="uk-width-medium-1-4">
                            ...
                            <input class="md-input" type="text" name="ps_contact_name" id="ps_contact_name"
                                value="{{ $getProductServiceData['ps_contact_name'] }}" placeholder="Enter Contact Name"
                                required>
                        </div>
                        <div class="uk-width-medium-1-4">
                            <label class="form-label">Phone Number <span class="text-danger">*</span></label>
                            <input class="md-input" type="text" name="ps_contact_number" id="ps_contact_number"
                                value="{{ $getProductServiceData['ps_contact_number'] }}"
                                placeholder="Enter Phone Number" required>
                        </div>
                        <div class="uk-width-medium-1-4">
                            <label class="form-label">WhatsApp</label>
                            <input class="md-input" type="text" name="ps_contact_whatsapp" id="ps_contact_whatsapp"
                                value="{{ $getProductServiceData['ps_contact_whatsapp'] }}" placeholder="Enter WhatsApp">
                        </div>
                        <div class="uk-width-medium-1-4">
                            <label class="form-label">Email <span class="text-danger">*</span></label>
                            <input class="md-input" type="email" name="ps_contact_email" id="ps_contact_email"
                                value="{{ $getProductServiceData['ps_contact_email'] }}" placeholder="Enter Email"
                                required>
                        </div>
                        ...
                        <div class="uk-width-medium-1-4">
                            ...
                            <input class="md-input" type="text" name="ps_twitter_url" id="ps_twitter_url"
                                value="{{ $getProductServiceData['ps_twitter_url'] }}" placeholder="Enter Twitter Link">
                        </div>
                        <div class="uk-width-medium-1-4">
                            <label class="form-label">Other Link </label>
                            <input class="md-input" type="text" name="ps_other_url" id="ps_other_url"
                                value="{{ $getProductServiceData['ps_other_url'] }}" placeholder="Enter Other Link">
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="uk-width-medium-1-4">
                            ...
                            <select name="ps_visibility" id="ps_visibility" class="md-input" required>
                                <option value="">Select</option>
                                <option value="Public"
                                    @if ($getProductServiceData['ps_visibility'] == 'Public') selected style="color:red" @endif>Public</option>
                                <option value="Private"
                                    @if ($getProductServiceData['ps_visibility'] == 'Private') selected style="color:red" @endif>Private</option>
                            </select>
                        </div>
                        <div class="uk-width-medium-1-4">
                            <label class="form-label">Featured Listing <span class="text-danger">*</span></label>
                            <input class="md-input" type="text" name="ps_featured_listing" id="ps_featured_listing"
                                value="{{ $getProductServiceData['ps_featured_listing'] }}"
                                placeholder="Enter Featured Listing" required>
                        </div>
                        <div class="uk-width-medium-1-4">
                            <label class="form-label">Expiry Date <span class="text-danger">*</span></label>
                            <input class="md-input" type="date" name="ps_expiry_date"
                                value="{{ $getProductServiceData['ps_expiry_date'] }}" id="ps_expiry_date" required>
                        </div>
                        <div class="uk-width-medium-1-4">
                            <label class="form-label">Tags / Keywords (Products/Services) <span
                                    class="text-danger">*</span></label>
                            <input class="md-input" type="text" name="ps_tags_keywords"
                                value="{{ $getProductServiceData['ps_tags_keywords'] }}" id="ps_tags_keywords"
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-1">
                            ...
                            <textarea class="md-input" name="ps_short_description" id="ps_short_description"
                                placeholder="Enter Short Description" required>{{ $getProductServiceData['ps_short_description'] }}</textarea>
                        </div>
                        <div class="uk-width-medium-1-1">
                            <label class="form-label">Detail Description <span class="text-danger">*</span></label>
                            <br>
                            <textarea class="md-input" id="editor" name="ps_detail_description" id="ps_detail_description"
                                placeholder="Enter Detail Description" required>{{ $getProductServiceData['ps_detail_description'] }}</textarea>
                        </div>
                        
                        <div class="uk-width-1-1">
                             <label for="bus_meta_description">Admin Comment</label>
                             <div class="parsley-row">
                                <textarea class="md-input" name="ps_admin_comment" cols="10" rows="8">{{ $getProductServiceData['ps_admin_comment'] }}</textarea>
                            </div>
                        </div>
