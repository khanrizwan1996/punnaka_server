               ...
               <table id="tableID" class="display">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td>{{ $i++ }}</td>
                        <td>
                           @if($couponRow['coupon_status'] == 0)
                           <center>
                              <div class="dropdown">
                                 <a class="activeUrl" style="font-size:25px; cursor:pointer"><i class="fa fa-gear"></i></a>
                                 <div class="dropdown-content">
                                    <a href="{{url('couponEdit/'.$couponRow['coupon_id'])}}" > Edit Detail</a>
                                 </div>
                              </div>
                           </center>
                           @else
                        ...
                        <td>@if($couponRow['coupon_status'] == 0)
                        ...
                        <td>{{ $couponRow['coupon_brand_name'] }}</td>
                        <td>{{ $couponRow['coupon_company_name'] }}</td>
                        ...
                        <td>
                           @if($couponRow['coupon_status'] == 0)
                           <a href="{{url('couponEdit/'.$couponRow['coupon_id'])}}" class="activeUrl"><i class="fa fa-edit"></i> Edit Details</a>
                           @else
                           <center> <b>-</b> </center>
                           @endif
                        </td>
