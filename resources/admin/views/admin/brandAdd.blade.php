    ...
    <div id="page_content_inner">
        ...
        <div class="md-card">
            <div class="md-card-content large-padding">
                <form id="form_validation" method="POST" action="{{ url('admin/brandStore') }}"
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="uk-width-medium-1-3">
                            <div class="parsley-row">
                                <label for="brand_contact_no">Contact No <span class="req" style="color: red">*</span></label>
                    ...
                    <div class="uk-grid">
                        <div class="uk-width-1-1">
                            ...
                            <div class="parsley-row">
                                <textarea class="md-input" id="editor" name="brand_desc" required cols="10" rows="8"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="uk-grid">
                        <div class="uk-width-1-1">
                            <div class="parsley-row">
                                ...
                                <textarea class="md-input" name="brand_meta_description" cols="10" rows="8"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="uk-grid">
                        <div class="uk-width-medium-1-3">
                            <label for="brand_logo">Brand Logo <span class="req" style="color: red">*</span></label>
                            <div class="parsley-row">
                        ...
                        <div class="uk-width-medium-1-3">
                            <label for="brand_img_path">Brand Multiple <span class="req"
                                    style="color: red">*</span></label>
                            <div class="parsley-row">
                                <input type="file" name="brand_img_path[]" multiple
                                    onchange='single_attachment(this,{{ JPG_PNG_FORMATES }},{{ IMAGE_SIZE }})'
                                    class="md-btn md-btn-primary md-input" />
                            </div>
                        </div>
